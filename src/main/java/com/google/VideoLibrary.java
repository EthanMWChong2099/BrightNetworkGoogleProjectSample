...
class VideoLibrary {
  ...
  VideoLibrary() {
    ...
    try {
      File file = new File("C:/Users/ethan/Desktop/Ethan's Folder/Degree Course/Summer Stuff/Bright Network IEUK 2021/Google Coding Challenge/google-code-sample/java/src/main/resources/videos.txt").getAbsoluteFile();
